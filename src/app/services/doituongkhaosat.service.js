...
function getAll(id, idNhomKhaoSat,idKeHoach,key) {
  return axios.get(process.env.REACT_APP_URL_SERVER + `/be-form/doi-tuong-khao-sat?id=${id}&idNhomKhaoSat=${idNhomKhaoSat||""}&idKeHoach=${idKeHoach||""}&key=${key||""}`);
}
