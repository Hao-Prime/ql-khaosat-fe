...
const LoginPage = () => {
    ...
    const handleLogin = () => {
        ...
        setError("")
        if(!user?.tenDangNhap){
            setError("Cần nhập tên đăng nhập")
            return
    ...
    const lienHe = () => {
        alert("Liên hệ quản trị viên để được xử lý")
    }
    return (
        ...
        <div className="container-login">
            ...
            <div className="form">
                <div className="flex-column">
                    <label><h5 className="bold text-center f-20 mb-2 title-login">HỆ THỐNG QUẢN LÝ ĐIỀU TRA KHẢO SÁT THÔNG TIN</h5></label>
                </div>
                <div className="flex-column">
                ...
                <div className="inputForm">
                    ...
                    <input type="text" className="input" placeholder="Nhập số điện thoại / email"
                        onChange={(e) => handleChange("tenDangNhap", e?.target?.value)}
                        onKeyDown={(e) => {
                            if (e.key === "Enter") {
                                handleLogin()
                ...
                <div className="flex-row">
                    ...
                    <span className="span" onClick={lienHe}>Quên mật khẩu?</span>
                </div>
                <i className="red ">{error}</i>
                <button className="button-submit div-flex justify-center" disabled={sending} onClick={() => {
                    handleLogin()
                    // console.log("XXX");
                ...
                >
                    <span style={{ display: sending ? 'inherit' : 'none' }} >
                        <CircularProgress className="span-sender white" />
                    </span> Đăng nhập</button>
                <p className="p">
                    Chưa có tài khoản? <span className="span" onClick={lienHe}>Đăng ký</span>
                </p>
