...
const ChangePassModal = ({ open, setOpen }) => {
    ...
    const onSubmit = async () => {
        ...
        const res = await Services?.getTaiKhoanService()?.doiMatKhau(nguoiDung);
        ...
        setSending(false);
        // Services?.getTaiKhoanService()?.doiMatKhau(nguoiDung)?.then(
        //     (res) => {
        //         if (res?.data?.error) {
